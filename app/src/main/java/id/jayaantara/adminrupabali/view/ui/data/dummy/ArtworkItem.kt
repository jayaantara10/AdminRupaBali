...
data class ArtworkItem(
    ...
    val like: String,
    val imageUrl: String,
    val fine_art_category: String,
    val artwork_category: String,
    val creation_date: String,
    val scared_status: String,
...
val artworkItems = listOf<ArtworkItem>(
    ArtworkItem(
        title = "Rerajahan Durga",
        artist = "Gusti Made",
        verificationNumber = "#2023020600001",
        verificationStatus = "UNVALID",
        isSuspend = false,
        like = "1M",
        imageUrl = "https://i0.wp.com/masbrooo.com/wp-content/uploads/2018/03/rajah2.jpg?resize=1064%2C1080&ssl=1",
        fine_art_category = "Rerajahan",
        artwork_category = "Kawisesan",
        creation_date = "19 September 1995",
        scared_status = "Sakral",
        ...
        updatedAt = "06/02/2023"
        ),

    ArtworkItem(
        title = "Dedari",
        artist = "Gusti Made",
        verificationNumber = "#2023020600002",
        verificationStatus = "UNVALID",
        isSuspend = false,
        like = "1M",
        imageUrl = "https://kabarnusa.com/assets/images/lukisan-bali-sumbang-devisa.jpg",
        fine_art_category = "Rerajahan",
        artwork_category = "Kawisesan",
        creation_date = "19 September 1995",
        scared_status = "Sakral",
    ...
    ArtworkItem(
        title = "Kala Rahu",
        artist = "Gusti Made",
        verificationNumber = "#2023020600003",
        verificationStatus = "UNVALID",
        isSuspend = false,
        like = "1M",
        imageUrl = "https://images-tm.tempo.co/all/2022/06/03/802069/802069_1200.jpg",
        fine_art_category = "Rerajahan",
        artwork_category = "Kawisesan",
        creation_date = "19 September 1995",
        scared_status = "Sakral",
    ...
    ArtworkItem(
        title = "Kedis Putih",
        artist = "Gusti Made",
        verificationNumber = "#2023020600004",
        verificationStatus = "UNVALID",
        isSuspend = false,
        like = "1M",
    ...
    ArtworkItem(
        title = "Gadis Bali",
        artist = "Gusti Made",
        verificationNumber = "#2023020600005",
        verificationStatus = "UNVALID",
        isSuspend = false,
        like = "1M",
        imageUrl = "https://qph.cf2.quoracdn.net/main-qimg-e4909ea09c88bf3dfd28177b84e296d1-lq",
        fine_art_category = "Rerajahan",
        artwork_category = "Kawisesan",
        creation_date = "19 September 1995",
        scared_status = "Sakral",
    ...
    ArtworkItem(
        title = "Topeng",
        artist = "Gusti Made",
        verificationNumber = "#2023020600006",
        verificationStatus = "UNVALID",
        isSuspend = false,
        like = "1M",
        imageUrl = "https://asset.kompas.com/crops/MlfyIFy1fwl1n7qliBDYc5g8bnQ=/9x201:995x858/750x500/data/photo/2019/05/15/1943777453.jpg",
        fine_art_category = "Rerajahan",
        artwork_category = "Kawisesan",
        creation_date = "19 September 1995",
        scared_status = "Sakral",

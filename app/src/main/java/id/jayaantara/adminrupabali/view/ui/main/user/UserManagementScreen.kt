package id.jayaantara.adminrupabali.view.ui.main.user
    ...
    Row(
        ...
        Column(
            ...
            Text(
                style = Typography.h1,
                maxLines = 1,
                text = stringResource(id = R.string.management_user_title)
            )
            ...
            Text(
                ...
                maxLines = 3,
                text = stringResource(id = R.string.management_user_description)
            )
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    ...
                    style = Typography.h2,
                    maxLines = 1,
                    text = stringResource(id = R.string.list_user_title)
                )
...
private fun UserManagementScreenPreview() {
    AdminRupaBaliTheme(darkTheme = false) {
        UserManagementScreen(navController = rememberNavController(), navbarWidth = 48.dp)
    }
}
package id.jayaantara.adminrupabali.view.ui.main.admin
    ...
    Row(
        ...
        Column(
            ...
            Text(
                style = Typography.h1,
                maxLines = 1,
                text = stringResource(id = R.string.management_admin_title)
            )
            ...
            Text(
                ...
                maxLines = 3,
                text = stringResource(id = R.string.management_admin_description)
            )
...
private fun DataListView(
    ...
    // Search State
    val searchBarHint = stringResource(id = R.string.label_admin_search_bar)
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    ...
                    style = Typography.h2,
                    maxLines = 1,
                    text = stringResource(id = R.string.list_admin_title)
                )
...
@Composable
private fun AdminManagementScreenPreview() {
    AdminRupaBaliTheme(darkTheme = false) {
        AdminManagementScreen(navController = rememberNavController(), navbarWidth = 48.dp)
    }
}
package id.jayaantara.adminrupabali.view.ui.main.news
    ...
    Row(
        ...
        Column(
            ...
            Text(
                style = Typography.h1,
                maxLines = 1,
                text = stringResource(id = R.string.management_news_title)
            )
            ...
            Text(
                ...
                maxLines = 3,
                text = stringResource(id = R.string.management_news_description)
            )
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    ...
                    style = Typography.h2,
                    maxLines = 1,
                    text = stringResource(id = R.string.list_news_title)
                )
...
@Composable
private fun NewsManagementScreenPreview() {
    AdminRupaBaliTheme(darkTheme = false) {
        NewsManagementScreen(navController = rememberNavController(), navbarWidth = 48.dp)
    }
}
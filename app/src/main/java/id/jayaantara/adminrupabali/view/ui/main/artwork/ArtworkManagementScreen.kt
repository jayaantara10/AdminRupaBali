package id.jayaantara.adminrupabali.view.ui.main.artwork
    ...
    Row(
        ...
        Column(
            ...
            Text(
                style = Typography.h1,
                maxLines = 1,
                text = stringResource(id = R.string.management_artwork_title)
            )
            ...
            Text(
                ...
                maxLines = 3,
                text = stringResource(id = R.string.management_artwork_description)
            )
...
private fun DataListView(
    ...
    // Search State
    val searchBarHint = stringResource(id = R.string.label_artwork_search_bar)
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    ...
                    style = Typography.h2,
                    maxLines = 1,
                    text = stringResource(id = R.string.list_artwork_title)
                )
...
@Composable
private fun ArtworkManagementScreenPreview() {
    AdminRupaBaliTheme(darkTheme = false) {
        ArtworkManagementScreen(navController = rememberNavController(), navbarWidth = 48.dp)
    }
}
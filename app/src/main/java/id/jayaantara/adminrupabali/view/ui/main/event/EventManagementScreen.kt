package id.jayaantara.adminrupabali.view.ui.main.event
    ...
    Row(
        ...
        Column(
            ...
            Text(
                style = Typography.h1,
                maxLines = 1,
                text = stringResource(id = R.string.management_event_title)
            )
            ...
            Text(
                ...
                maxLines = 3,
                text = stringResource(id = R.string.management_event_description)
            )
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    ...
                    style = Typography.h2,
                    maxLines = 1,
                    text = stringResource(id = R.string.list_event_title)
                )
...
@Composable
private fun EventManagementScreenPreview() {
    AdminRupaBaliTheme(darkTheme = false) {
        EventManagementScreen(navController = rememberNavController(), navbarWidth = 48.dp)
    }
}
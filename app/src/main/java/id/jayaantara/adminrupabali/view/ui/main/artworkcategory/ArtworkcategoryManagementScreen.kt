package id.jayaantara.adminrupabali.view.ui.main.artworkcategory
...
@Composable
fun ArtworkCategoryManagementScreen(
    ...
    Row(
        ...
        Column(
            ...
            Text(
                style = Typography.h1,
                maxLines = 1,
                text = stringResource(id = R.string.management_artwork_category_title)
            )
            ...
            Text(
                ...
                maxLines = 3,
                text = stringResource(id = R.string.management_artwork_category_description)
            )
...
private fun DataListView(
    ...
    // Search State
    val searchBarHint = stringResource(id = R.string.label_artwork_category_search_bar)
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    ...
                    style = Typography.h2,
                    maxLines = 1,
                    text = stringResource(id = R.string.list_artwork_category_title)
                )
...
@Composable
private fun ArtworkCategoryManagementScreenPreview() {
    AdminRupaBaliTheme(darkTheme = false) {
        ArtworkCategoryManagementScreen(navController = rememberNavController(), navbarWidth = 48.dp)
    }
}